...
from paper_agent.adapters.base import CollectedPaper, CollectionResult, ParseReject
from paper_agent.adapters.pmlr import PmlrAdapter
from paper_agent.catalog import load_venue_spec
from paper_agent.errors import CollectionError, ContractError
from paper_agent.models import Pagination
...
def test_new_adapter_modules_do_not_import_the_legacy_package() -> None:
    root = Path(__file__).resolve().parents[3] / "src" / "paper_agent" / "adapters"
    violations: list[str] = []
