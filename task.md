...
- [ ] EDA 与 Crossref 期刊字段补全已接入 membership-preserving DOI batch hydrator，但尚未达到十年全字段完成门槛。2024 实测 DAC 为 369/370 abstract、370/370 DOI/PDF，ICCAD 为 234/239 abstract、239/239 DOI/PDF；JCIM 为 805/805 DOI/PDF，但本轮 Semantic Scholar HTTP 429 阻断摘要补全。所有缺口均保持严格 `incomplete`，不得在剩余 6 篇 EDA 摘要及 17 期刊逐年验证完成前勾选。
