...
- [ ] Stage 1 独立接口已对原目录 35 个 venue 完成 2016–2025 严格 membership census，并已新增 TMLR、TPAMI、DATE、ASP-DAC、ISPD、TODAES、TVLSI、JSSC 的 descriptor/fixture contract；新 venue 尚未完成 live decade census，因此不能勾选全目录 membership 完成。原 35-venue 证据见 `docs/acceptance/stage1-decade-census-20260812.json`；全目录 receipt 审计接口及当前 incomplete 结果见 `docs/acceptance/stage1-field-matrix-20260814.md`。ICLR、DAC、ICCAD 使用完整 DBLP proceedings TOC 作为声明的领域权威：ICLR 共 11,294 篇，DAC 排除 1 条 Frontmatter 后 2,668 篇，ICCAD 排除 1 条 Foreword 后 1,785 篇。ICLR 官网 accepted-event 与 proceedings 的 2022/2023 单条差异均为后来撤稿，不并入最终 proceedings。此项证明原 35 venue membership 无遗漏，不冒充摘要、DOI 等可选字段全覆盖。
...
- [ ] EDA 与 Crossref 期刊字段补全已接入 membership-preserving DOI batch hydrator，但尚未达到十年全字段完成门槛。2024 实测 DAC 已由 OpenAlex 精确 DOI/标题回填至 370/370 abstract、370/370 DOI/PDF；ICCAD 为 234/239 abstract、239/239 DOI/PDF，剩余 5 条受 ACM Cloudflare、Semantic Scholar 429 与 OpenAlex 公共配额耗尽影响，保持 incomplete。JCIM 2024、ACS Central Science 2024、JACS 2024、Chemical Science 2024、JCTC 2024 以及六个 Nature 代表性期刊年份均已严格通过，并将确有证据的封面、目录、新闻、修正、社论等标为 `legitimately_absent`。Nature Communications 2024 为 10,926/10,926 DOI/PDF、10,434 条真实摘要 + 492 条不适用；Chemical Science 2024 为 2,091/2,091 DOI/PDF、1,874 条真实摘要 + 217 条不适用，RSC DOI-derived PDF 仅是 Stage 3 候选位置。Cell 2024 已达 548/548 DOI/PDF、520 条真实摘要 + 27 条不适用，仍有 1 条普通记录；TCAD 2024 已达 429/429 DOI/PDF、385 条真实摘要 + 37 条不适用，仍有 7 条普通记录。Science 2024 为 1,741/2,039 abstract、2,039/2,039 DOI/PDF；其 298 个新闻、信件、更正等页面受无人值守 Cloudflare challenge 影响，继续保持 incomplete。ICLR 2017、ICCAD 5 条和 Science 缺口仍待合规官方来源。期刊路径先用 Europe PMC DOI 批量补全，Semantic Scholar 为可失败回退；Nature 系列再以独立、条款受控的 4 QPS 官方文章页补 `dc.description`。仍须完成上述残余项目及 2016–2025 全字段矩阵后才能勾选本项。
