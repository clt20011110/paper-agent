...
- [ ] EDA 与 Crossref 期刊字段补全已接入 membership-preserving DOI batch hydrator，但尚未达到十年全字段完成门槛。2024 实测 DAC 为 369/370 abstract、370/370 DOI/PDF，ICCAD 为 234/239 abstract、239/239 DOI/PDF。JCIM 2024 已严格通过：805/805 DOI/PDF，740 条真实摘要，另 65 条经冻结题名规则证明为 masthead、publication information、correction、addition、editorial 等摘要不适用文献。Nature Machine Intelligence 2024 也已严格通过：184/184 DOI/PDF，166 条真实摘要，18 条由 Nature 官方文档类型证明为摘要不适用。Angewandte Chemie 2024 最佳实测为 5,170/5,170 DOI/PDF、4,817 条真实摘要，其余恰为 300 个封面/图文摘要、37 个 corrigendum、16 个 classifieds，已冻结锚定规则；后续严格重跑因 Europe PMC read timeout 仍为 incomplete，尚不能记作严格通过。Science 2024 为 1,741/2,039 abstract、2,039/2,039 DOI/PDF；其 298 个新闻、信件、更正等页面受无人值守 Cloudflare challenge 影响，继续保持 incomplete。期刊路径先用 Europe PMC DOI 批量补全，Semantic Scholar 为可失败回退；Nature 系列再以独立、条款受控的 4 QPS 官方文章页补 `dc.description`，其它期刊可用精确标题 arXiv 批量残余回填。仍须完成剩余 6 篇 EDA 摘要、Science 缺口及其余期刊逐年验证后才能勾选本项。
