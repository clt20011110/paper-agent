...
def write_stage2_release_evidence_index(
    *,
    ...
    document: dict[str, Any] = {
        ...
        "public_gates": {
            "structured_replay": {"manifest": refs["structured_manifest"], "records": refs["structured_records"]},
            "rationale": {"manifest": refs["rationale_manifest"], "records": refs["rationale_records"]},
            "parity": parity_refs,
