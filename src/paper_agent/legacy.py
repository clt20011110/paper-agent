...
_VENUE_DESCRIPTORS = {
    ...
    "Angewandte Chemie International Edition": "venues/angewandte_chemie.yaml",
    "Chemical Science": "venues/chemical_science.yaml",
    "ACS Central Science": "venues/acs_central_science.yaml",
    "Journal of Chemical Information and Modeling": "venues/jcim.yaml",
    "Journal of Chemical Theory and Computation": "venues/jctc.yaml",
